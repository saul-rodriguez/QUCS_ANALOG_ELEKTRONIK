...
<Properties>
  <View=-180,-229,2360,1339,0.564475,0,0>
  <Grid=10,10,0>
...
<Components>
  ...
  <.TR TR1 1 630 -190 0 79 0 0 "lin" 1 "0" 1 "2 ms" 1 "11" 0 "Trapezoidal" 0 "2" 0 "1 ns" 0 "1e-16" 0 "150" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "26.85" 0 "1e-3" 0 "1e-6" 0 "1" 0 "CroutLU" 0 "no" 0 "yes" 0 "0" 0>
  <R R1 1 320 120 -26 15 0 0 "10k" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
  <.AC AC1 1 30 -200 0 49 0 0 "log" 1 "1" 1 "1GHz" 1 "181" 1 "no" 0>
</Components>
<Wires>
...
<Diagrams>
  ...
  <Rect 1590 928 681 378 3 #c0c0c0 1 10 1 1 1 1e+09 1 -43.5393 20 120 1 -100 20 8.60398 315 0 225 "" "" "">
	...
	<"ngspice/ac.b_inv_db" #00aa00 2 3 0 0 0>
	  <Mkr 2.99358e+06 480 -254 3 0 0>
	<"ngspice/ac.fas_bav0" #ff00ff 2 3 0 0 1>
  </Rect>
  <Rect 10 1233 672 283 3 #c0c0c0 1 00 1 0 0.0002 0.002 1 -0.0909078 0.5 1 1 -1 0.5 1 315 0 225 "" "" "">
	<"ngspice/tran.v(av)" #0000ff 0 3 0 0 0>
  </Rect>
  <Rect 770 937 681 377 3 #c0c0c0 1 10 1 1 1 1e+10 1 -100 50 123.617 1 -100 20 8.60398 315 0 225 "" "" "">
	<"ngspice/ac.av0_db" #0000ff 2 3 0 0 0>
	<"ngspice/ac.bav0_db" #ff0000 2 3 0 0 0>
	  <Mkr 3.34048e+06 554 -187 3 0 0>
	<"ngspice/ac.fas_bav0" #ff00ff 2 3 0 0 1>
	  <Mkr 155.052 20 -145 3 0 0>
	  <Mkr 15.5052 170 -372 3 0 0>
	  <Mkr 3.34048e+06 554 -95 3 0 0>
  </Rect>
</Diagrams>
<Paintings>
