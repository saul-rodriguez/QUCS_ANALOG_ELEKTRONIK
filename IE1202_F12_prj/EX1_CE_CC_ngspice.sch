...
<Properties>
  <View=60,121,1511,1120,0.909091,58,60>
  <Grid=10,10,0>
  <DataSet=EX1_CE_CC_ngspice.dat>
  <DataDisplay=EX1_CE_CC_ngspice.dpl>
  <OpenDisplay=0>
  <Script=EX1_CE_CC_ngspice.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <.TR TR1 1 120 570 0 78 0 0 "lin" 1 "0" 1 "2 ms" 1 "201" 0 "Trapezoidal" 0 "2" 0 "1 ns" 0 "1e-16" 0 "150" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "26.85" 0 "1e-3" 0 "1e-6" 0 "1" 0 "CroutLU" 0 "no" 0 "yes" 0 "0" 0>
  ...
  <IProbe Pr5 1 890 222 -41 -26 0 3>
  <SpicePar SpicePar1 1 1170 160 -29 19 0 0 "Uin=0.01" 1>
  <NutmegEq NutmegEq1 1 1170 260 -27 19 0 0 "ac" 1 "Av=(Vout/Uin)" 1>
...
<Wires>
  ...
  <660 330 860 330 "" 0 0 0 "">
  <890 360 890 430 "" 0 0 0 "">
  <750 580 890 580 "" 0 0 0 "">
  <890 510 890 580 "" 0 0 0 "">
  <890 252 890 300 "" 0 0 0 "">
  <890 150 890 192 "" 0 0 0 "">
  <890 430 890 450 "" 0 0 0 "">
  <890 430 1050 430 "Vout" 990 380 126 "">
...
<Diagrams>
  <Rect 1140 967 351 592 3 #c0c0c0 1 00 1 0 0.001 0.004 1 -0.348029 0.5 3.27142 1 -1 0.2 1 315 0 225 "" "" "">
