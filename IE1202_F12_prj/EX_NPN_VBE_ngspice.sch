...
<Properties>
  <View=274,191,1331,1238,1.17047,0,224>
  <Grid=10,10,0>
  <DataSet=EX_NPN_VBE_ngspice.dat>
  <DataDisplay=EX_NPN_VBE_ngspice.dpl>
  <OpenDisplay=0>
  <Script=EX_NPN_VBE_ngspice.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <SpicePar SpicePar1 1 900 240 -29 19 0 0 "VBE=0.6" 1 "VCE=1" 1>
  <.DC DC1 1 1000 240 0 47 0 0 "26.85" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "no" 0 "150" 0 "no" 0 "none" 0 "CroutLU" 0>
  <.SW SW1 1 1000 390 0 80 0 0 "DC1" 1 "lin" 1 "V2" 1 "0.5" 1 "0.8" 1 "151" 1 "false" 0>
  <.SW SW2 1 1170 390 0 80 0 0 "SW1" 1 "lin" 1 "V1" 1 "1" 1 "10" 1 "151" 1 "false" 0>
</Components>
<Wires>
...
<Diagrams>
  <Rect 400 804 472 294 3 #c0c0c0 1 00 1 0 0.1 1 1 -0.0086405 0.02 0.1 1 -1 0.5 1 315 0 225 "" "" "">
	<"ngspice/i(pr1)" #0000ff 0 3 0 0 0>
  </Rect>
  <Rect 400 1154 472 294 3 #c0c0c0 1 00 1 0.5 0.05 0.8 1 -0.0086405 0.02 0.1 1 -1 0.5 1 315 0 225 "" "" "">
