...
<Properties>
  <View=0,-153,902,800,1.331,0,0>
  <Grid=10,10,1>
  <DataSet=Mål3_2.dat>
  <DataDisplay=Mål3_2.dpl>
  <OpenDisplay=1>
  <Script=Mål3_2.m>
  <RunScript=0>
  <showFrame=0>
...
<Components>
  ...
  <C C1 1 320 120 -26 -63 0 2 "1n" 1 "" 0 "neutral" 0>
  <R R1 1 450 190 15 -26 0 1 "1k" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
</Components>
<Wires>
